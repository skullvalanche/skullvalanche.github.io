...
I'd rather not have to monkey with writing HTML code just to post a new entry, and I'm reasonably familiar with [Markdown](https://www.markdownguide.org/), so a [static site generator](https://en.wikipedia.org/wiki/Static_site_generator) (SSG) just made the most sense.
